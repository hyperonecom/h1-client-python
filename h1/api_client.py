...
from h1.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = BillingProjectReservationApi()
        api_instance.billing_project_reservation_assign  # this is an instance of the class Endpoint
        api_instance.billing_project_reservation_assign()  # this invokes api_instance.billing_project_reservation_assign.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.billing_project_reservation_assign.callable or self.callable in this class
