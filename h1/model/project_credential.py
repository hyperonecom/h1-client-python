...
class ProjectCredential(ModelNormal):
    ...
    def __init__(self, name, value, *args, **kwargs):  # noqa: E501
        """ProjectCredential - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): defaults to "ssh", must be one of ["ssh", ]  # noqa: E501
