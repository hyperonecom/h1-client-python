...
class NetworkingProjectNetadpCreate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, vm, network, *args, **kwargs):  # noqa: E501
        """NetworkingProjectNetadpCreate - a model defined in OpenAPI
