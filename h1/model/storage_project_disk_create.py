...
class StorageProjectDiskCreate(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, service, size, *args, **kwargs):  # noqa: E501
        """StorageProjectDiskCreate - a model defined in OpenAPI
