...
class RecoveryProjectPlanCreateRetention(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, interval, count, *args, **kwargs):  # noqa: E501
        """RecoveryProjectPlanCreateRetention - a model defined in OpenAPI
