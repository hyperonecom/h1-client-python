...
class IamProjectQuotaLimitPatch(object):
    ...
    @property
    def user(self):
        """Gets the user of this IamProjectQuotaLimitPatch.  # noqa: E501


        :return: The user of this IamProjectQuotaLimitPatch.  # noqa: E501
        :rtype: float
        """
        return self._user
    ...
    @user.setter
    def user(self, user):
        """Sets the user of this IamProjectQuotaLimitPatch.


        :param user: The user of this IamProjectQuotaLimitPatch.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IamProjectQuotaLimitPatch):
            return False
