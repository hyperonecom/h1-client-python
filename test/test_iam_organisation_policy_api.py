...
from h1-client-python.api.iam_organisation_policy_api import IamOrganisationPolicyApi  # noqa: E501
...
class TestIamOrganisationPolicyApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = h1-client-python.api.iam_organisation_policy_api.IamOrganisationPolicyApi()  # noqa: E501
