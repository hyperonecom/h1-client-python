...
from h1-client-python.models.iso import Iso  # noqa: E501
...
class TestIso(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = h1-client-python.models.iso.Iso()  # noqa: E501
        if include_optional :
            return Iso(
                id = '0', 
                name = '0', 
                ...
                uri = '0', 
                size = 1.337, 
                metadata = h1-client-python.models.iso_metadata.iso_metadata(
