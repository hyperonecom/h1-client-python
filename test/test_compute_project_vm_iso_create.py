...
from h1-client-python.models.compute_project_vm_iso_create import ComputeProjectVmIsoCreate  # noqa: E501
...
class TestComputeProjectVmIsoCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = h1-client-python.models.compute_project_vm_iso_create.ComputeProjectVmIsoCreate()  # noqa: E501
        if include_optional :
            return ComputeProjectVmIsoCreate(
                iso = '0'
            )
        else :
            return ComputeProjectVmIsoCreate(
