...
from h1-client-python.api.storage_project_disk_api import StorageProjectDiskApi  # noqa: E501
...
class TestStorageProjectDiskApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = h1-client-python.api.storage_project_disk_api.StorageProjectDiskApi()  # noqa: E501
