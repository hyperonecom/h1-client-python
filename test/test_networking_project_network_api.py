...
from h1-client-python.api.networking_project_network_api import NetworkingProjectNetworkApi  # noqa: E501
...
class TestNetworkingProjectNetworkApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = h1-client-python.api.networking_project_network_api.NetworkingProjectNetworkApi()  # noqa: E501
