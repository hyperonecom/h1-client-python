...
from h1-client-python.models.organisation import Organisation  # noqa: E501
...
class TestOrganisation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = h1-client-python.models.organisation.Organisation()  # noqa: E501
        if include_optional :
            return Organisation(
                id = '0', 
                name = '0', 
                ...
                billing = h1-client-python.models.organisation_billing.organisation_billing(
                    ...
                    address = h1-client-python.models.invoice_seller_address.invoice_seller_address(
                        ...
                        country = '0', ), 
                    nip = '0', ), 
                transfer = h1-client-python.models.organisation_transfer.organisation_transfer(
                    name = '0', 
                    id = '0', ), 
                bank_account = '0', 
                tag = [
