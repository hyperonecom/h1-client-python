...
from h1-client-python.models.disk import Disk  # noqa: E501
...
class TestDisk(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = h1-client-python.models.disk.Disk()  # noqa: E501
        if include_optional :
            return Disk(
                id = '0', 
                name = '0', 
                ...
                vm = '0', 
                persistent = True, 
                metadata = h1-client-python.models.disk_metadata.disk_metadata(
                    source = '0', ), 
                tag = [
