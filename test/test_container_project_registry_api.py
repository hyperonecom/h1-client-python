...
from h1-client-python.api.container_project_registry_api import ContainerProjectRegistryApi  # noqa: E501
...
class TestContainerProjectRegistryApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = h1-client-python.api.container_project_registry_api.ContainerProjectRegistryApi()  # noqa: E501
