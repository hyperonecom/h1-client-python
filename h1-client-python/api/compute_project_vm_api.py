...
class ComputeProjectVmApi(object):
    ...
    def compute_project_vm_console(self, project_id, location_id, vm_id, **kwargs):  # noqa: E501
        """Console compute/vm  # noqa: E501

        action console  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.compute_project_vm_console(project_id, location_id, vm_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.compute_project_vm_console_with_http_info(project_id, location_id, vm_id, **kwargs)  # noqa: E501

    def compute_project_vm_console_with_http_info(self, project_id, location_id, vm_id, **kwargs):  # noqa: E501
        """Console compute/vm  # noqa: E501

        action console  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.compute_project_vm_console_with_http_info(project_id, location_id, vm_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method compute_project_vm_console" % key
                )
        ...
        if self.api_client.client_side_validation and ('project_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `project_id` when calling `compute_project_vm_console`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('location_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `location_id` when calling `compute_project_vm_console`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('vm_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `vm_id` when calling `compute_project_vm_console`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/compute/{locationId}/project/{projectId}/vm/{vmId}/actions/console', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
