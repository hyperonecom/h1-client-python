...
*ComputeProjectVmApi* | [**compute_project_vm_console**](docs/ComputeProjectVmApi.md#compute_project_vm_console) | **POST** /compute/{locationId}/project/{projectId}/vm/{vmId}/actions/console | Console compute/vm
